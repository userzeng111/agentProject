    ...
    items: [
      {
        ...
        title: "归档测试任务-带有很长很长的作品标题用于移动端断词检查",
        summary: "归档摘要，包含已完成章节、创作模型和最近动作模型信息。",
        status: "completed",
        ...
        creative_mode: "original",
        novel_size: "short",
        creative_model_id: "gpt-5.4-archive-model-with-a-very-long-unbroken-identifier-20260630",
        last_action_model_id: "glm-5.1-last-action-model",
        created_at: now,
        updated_at: now,
        completed_at: now,
        chapter_count: 2,
